					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
							<ul class="info-account list-inline-block pull-right">
								...
								<li><a href="login.php"><span class="color"><i class="fa fa-key"></i></span>Login</a></li>
					...
					<div class="row">
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="logo logo1">
								...
								<a href="index.html"><img src="images/home/logo.png" alt="" style="width: 118px; height: 118px" /></a>
							</div>
						</div>
						<div class="col-md-5 col-sm-5 col-xs-12">
														...
														<div class="mega-new-arrival-slider product-slider">
															<div class="wrap-item group-navi" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1],[768,2]]">
																<div class="item-product item-product-grid text-center">
																	...
																	<div class="product-info">
																		<h3 class="product-title"><a href="detail.html">Iphone X</a></h3>
																		<div class="product-price">
																			<ins class="color"><span>€2.000</span></ins>
																		</div>
																		<div class="product-rate">
																			<div class="product-rating" style="width:100%"></div>
																		</div>
																		<div class="product-extra-link">
																			...
																			<a href="cart1.php" class="addcart-link">Add to cart</a>
																...
																<div class="item-product item-product-grid text-center">
																	...
																	<div class="product-info">
																		<h3 class="product-title"><a href="detail.html">SamSung Note8</a></h3>
																		<div class="product-price">
																			<ins class="color"><span>€1500</span></ins>
																		</div>
																		<div class="product-rate">
																			<div class="product-rating" style="width:100%"></div>
																		</div>
	...
	<section id="content">
		<div class="container">
			<div class="shop-banner banner-adv line-scale zoom-image">
				<a href="#" class="adv-thumb-link"><img src="images/shop/banner-grid.jpg" alt="" /></a>
