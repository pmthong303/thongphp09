				...
				if ($resultGetCartProduct->num_rows > 0) {
					...
					//while($elementProduct = mysqli_fetch_assoc($resultGetCartProduct)) {
						...
						echo "<tr>";
							...
							echo "</td>";
							echo "<td><a href='decrease_product_in_cart.php?id=$id'><img width='30px' src='dialog-1294429_960_720.png'>Decrease</a> | <a href='delete_product_in_cart.php?id=$id'><img width='30px' src='images.png'>Delete</a> | <a href='increase_product_in_cart.php?id=$id'><img width='30px' src='tải xuống.jpg'>Increase</a></td>";
						echo "</tr>";
						echo "</div>";
						$i++;
					}
